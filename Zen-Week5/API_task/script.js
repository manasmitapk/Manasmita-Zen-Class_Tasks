...
async function countryData(){
      ...
      for(let ind=0;ind<myArr.length;ind++){
        ...
        cardDiv.setAttribute("style","background: rgb(105,106,92);background: linear-gradient(90deg, rgb(143, 135, 89) 0%, rgba(205,197,115,1) 52%, rgba(98,98,81,1) 100%);");
        ...
        button.setAttribute("style","margin-left:50px; border-color: white; background: linear-gradient(90deg, rgb(143, 135, 89) 0%, rgba(205,197,115,1) 52%, rgba(98,98,81,1) 100%);");
